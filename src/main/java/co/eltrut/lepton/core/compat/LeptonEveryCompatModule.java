...
public class LeptonEveryCompatModule extends SimpleModule {
    ...
    public LeptonEveryCompatModule() {
        ...
        woodSlab = SimpleEntrySet.builder(WoodType.class, "wood_slab", LeptonBlocks.OAK.woods().getSlabBlock(),
                ...
                .includeModelsBlock(
                        ResourceLocation.fromNamespaceAndPath(CompatUtil.Mods.MINECRAFT, "oak_wood"),
                        ResourceLocation.fromNamespaceAndPath(Lepton.MOD_ID, "oak_wood_slab"),
                        ResourceLocation.fromNamespaceAndPath(Lepton.MOD_ID, "oak_wood_slab_top")
                )
...
//        this.addEntry(woodWall);
        ...
        strippedWoodSlab = SimpleEntrySet.builder(WoodType.class, "wood_slab", "stripped", LeptonBlocks.OAK.strippedWoods().getSlabBlock(),
                ...
                .includeModelsBlock(
                        ResourceLocation.fromNamespaceAndPath(CompatUtil.Mods.MINECRAFT, "stripped_oak_wood"),
                        ResourceLocation.fromNamespaceAndPath(Lepton.MOD_ID, "stripped_oak_wood_slab"),
                        ResourceLocation.fromNamespaceAndPath(Lepton.MOD_ID, "stripped_oak_wood_slab_top")
                )
                .setTab(() -> BuiltInRegistries.CREATIVE_MODE_TAB.get(CreativeModeTabs.BUILDING_BLOCKS))
                .setTabMode(TabAddMode.AFTER_SAME_WOOD)
                .addTag(BlockTags.MINEABLE_WITH_AXE, Registries.BLOCK)
