...
public class LeptonBlocks {
	...
	public static final RegistryObject<Block> POLISHED_MYALITE_WALL = HELPER.createSimpleBlock("polished_myalite_wall", () -> new WallBlock(Properties.MYALITE), ItemGroup.DECORATIONS, Mods.QUARK);
	...
	public static final RegistryObject<Block> POLISHED_MYALITE_BUTTON = HELPER.createSimpleBlock("polished_myalite_button", () -> new InjectedStoneButtonBlock(LeptonBlocks.Properties.BUTTON), ItemGroup.REDSTONE, Mods.QUARK);
	...
	public static final RegistryObject<Block> POLISHED_MYALITE_PRESSURE_PLATE = HELPER.createSimpleBlock("polished_myalite_pressure_plate", () -> new InjectedPressurePlateBlock(Sensitivity.MOBS, Properties.MYALITE_PRESSURE_PLATE), ItemGroup.REDSTONE, Mods.QUARK);
