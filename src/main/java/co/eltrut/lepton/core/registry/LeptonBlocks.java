...
public class LeptonBlocks {
	...
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_SLAB = HELPER.createSimpleFuelBlock("stripped_glowshroom_hyphae_slab", () -> new AlphaLogSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD).notSolid().setLightLevel(value -> 14)), ItemGroup.BUILDING_BLOCKS, 150, Mods.ENHANCED_MUSHROOMS);
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_STAIRS = HELPER.createSimpleFuelBlock("stripped_glowshroom_hyphae_stairs", () -> new AlphaLogStairsBlock(Blocks.STRIPPED_OAK_WOOD::getDefaultState, Block.Properties.from(Blocks.STRIPPED_OAK_WOOD).notSolid().setLightLevel(value -> 14)), ItemGroup.BUILDING_BLOCKS, 300, Mods.ENHANCED_MUSHROOMS);
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_WALL = HELPER.createSimpleFuelBlock("stripped_glowshroom_hyphae_wall", () -> new AlphaLogWallBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD).notSolid().setLightLevel(value -> 14)), ItemGroup.DECORATIONS, 300, Mods.ENHANCED_MUSHROOMS);
	...
	public static final RegistryObject<Block> GLOWSHROOM_HYPHAE_SLAB = HELPER.createSimpleFuelBlock("glowshroom_hyphae_slab", () -> new AlphaLogSlabBlock(STRIPPED_GLOWSHROOM_HYPHAE_SLAB, Block.Properties.from(Blocks.OAK_WOOD).notSolid().setLightLevel(value -> 14)), ItemGroup.BUILDING_BLOCKS, 150, Mods.ENHANCED_MUSHROOMS);
